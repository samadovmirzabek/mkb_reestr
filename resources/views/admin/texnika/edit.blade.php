    ...
    <div class="col-md-12">
       <div class="card">
          <div class="card-header">
             <h5 class="card-title " style="text-align:center">Tenikalarni Tahrirlash Sahifasi</h5>
          </div>
          <div class="card-body">
             <form action="{{ route('texnika.update',['texnika'=>$electronica->id]) }}" method="POST">
                @csrf
                @method('put')
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6" id="for_filial">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control stil" name="filial_name" disabled/>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6" style="display: none" id="filial">
                        <div class="form-group">
                           ...
                           <select class="form-control form-control-sm" name="filial_id" id="place_dist" required>
                        ...
                        <div class="form-group">
                           ...
                           <select class="select" name="texnika_id" onchange="getTexnika(this);">
                              <option value="" disabled selected hidden></option>
                                  @isset($texnika)
                                   @for($i=0; $i < 2; $i++)
                                   <option  selected="" value="{{ $electronica->texnika->id }}">{{ $electronica->texnika->name }}</option>
                                   @endfor
                                   @endisset
                           </select>
                        </div>
